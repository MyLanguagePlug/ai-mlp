                ...
                {lessonsOpen && (
                  <div className="divide-y divide-border border-t border-border">
                    ...
                    <div className="px-4 py-3">
                      <p className="mb-2 text-[10px] font-bold uppercase tracking-wider text-[#354d73]">
                        Upcoming
                      </p>
                      <div className="space-y-3">
                        {upcomingLessons.map(lesson => (
                          <div key={lesson.id} className="flex items-start gap-2">
                            <div className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#354d73]/10">
                              <Calendar className="h-3 w-3 text-[#354d73]" />
                            </div>
                            <div>
                              <p className="text-[11px] font-semibold leading-tight text-[#042230]">
                                {lesson.tutor}
                              </p>
