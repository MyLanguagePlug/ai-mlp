...
// Fraction of the visible carousel width to scroll per click
  ...
  ({ offerIcon, offerTitle, offerSubtitle, ctaText, onCtaClick, items, className }, ref) => {
    ...
    const scroll = (direction: "left" | "right") => {
      if (carouselRef.current) {
        const scrollAmount = carouselRef.current.clientWidth * SCROLL_PERCENTAGE;
        const newScrollLeft =
        ...
        <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-12">
          ...
          <div className="flex flex-col items-center text-center lg:col-span-3 lg:items-start lg:text-left">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-muted-foreground">Exclusive for our learners!</p>
            </div>
          ...
          <div className="relative lg:col-span-9">
            <div ref={carouselRef} className="overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              <motion.div
